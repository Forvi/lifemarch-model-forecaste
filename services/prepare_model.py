...
def model_predict(path_to_file):
    ...
    cols_to_drop = [
        ...
        'Группа по продажам в общих продажах', 'Группа по доходу в общих продажах', 'Категория 1', 'Категория 2',
        ...
        'СрВзв размер уценки', 'СрВзв размер скидки по ПЛ', 'Себестоимость списаний', 'Себестоимость за единицу',
    ...
    df_start["закупка"] = np.round(redicted_value)
